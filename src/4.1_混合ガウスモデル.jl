...
# ╔═╡ 419e2590-00ee-11ed-0758-19663573ebe4
begin
	using Distributions
	using FillArrays
	using StatsPlots
...
# ╔═╡ 5730f846-0846-4209-a686-8fbed7ef9940
using Turing

# ╔═╡ 43caf1de-435f-4de4-9e2a-eb2a46bb5a12
begin
	w = [0.5, 0.5]
	μ = [-3.5, 0.5]
...
# ╔═╡ 9dd5faa0-e8b5-42fe-b0ad-54353823a93c
begin
	N = 60
	x = rand(mixturemodel, N)
end

# ╔═╡ 353b39b4-62d0-4b77-b09f-d694e237c9ca
scatter(x[1, :], x[2, :]; legend=false, title="Synthetic Dataset")

# ╔═╡ b1c23e67-698e-4f8a-8ff7-84cfff192e12
...
# ╔═╡ be79a270-1906-4b56-8314-1c50f951c7a1
model = gaussian_mixture_model(x);

# ╔═╡ 656be7df-b249-4255-85d5-abb998294319
begin
...
# ╔═╡ 80165d19-4ea0-43e3-ba6e-01f12513b89a
plot(chains[["μ[1]", "μ[2]"]]; colordim=:parameter, legend=true)

# ╔═╡ 752a60e2-7b0f-450a-bd89-e67c57ad80c6
plot(chains[["μ[1]", "μ[2]"]]; colordim=:parameter, legend=true)

# ╔═╡ ecf23ffd-3ed9-4924-9bda-6185e3be9a0c
chain = chains[:, :, 1];

# ╔═╡ 772a9de8-f6a8-4105-a076-cdd2b5dba0fd
begin
...
# ╔═╡ 147595f4-8d21-47b5-9c49-b511454f8184
begin
...
# ╔═╡ 56901e0a-f803-4834-8cbc-31351028d259
